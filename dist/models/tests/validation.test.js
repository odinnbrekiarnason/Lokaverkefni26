...
import { CreateUserSchema, LoginSchema, IdSchema, CreateBookingSchemaQuery, editUserSchema, eventFiltersSchema, PaymentSchemaBody } from '../../config/schemas/schemas';
describe('Input Validation - Zod Schemas', () => {
    ...
    describe('Booking Schemas', () => {
        describe('CreateBookingSchemaQuery', () => {
            it('should validate correct booking data', () => {
                ...
                expect(() => CreateBookingSchemaQuery.parse(bookingData)).not.toThrow();
            });
            it('should reject negative user_id', () => {
                ...
                expect(() => CreateBookingSchemaQuery.parse(bookingData)).toThrow();
            });
            ...
            it('should default quantity to 1', () => {
                ...
                const result = CreateBookingSchemaQuery.parse(bookingData);
